...
if(isset($_POST['Objectives'])&&!empty($_POST['Course-Description'])) {
...
if(isset($_POST['Prerequisites'])&&!empty($_POST['Course-Description'])) {
...
if(isset($_POST['Project'])&&!empty($_POST['Course-Description'])) {
